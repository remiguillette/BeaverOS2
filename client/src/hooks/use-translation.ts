...
const translations = {
  en: {
    ...
    'beaverpatch.initialCallInformation': 'Initial Call Information',
    'beaverpatch.dispatchMap': 'Dispatch Map',
    'beaverpatch.unitStatus': 'Unit Status',
    'beaverpatch.assignUnits': 'Assign Units',
    'beaverpatch.selectIncident': 'Select an Incident',
    'beaverpatch.clickToAssignUnits': 'Click on an incident to assign units',
    'beaverpatch.availableUnits': 'Available Units',
    'beaverpatch.noUnitsAvailable': 'No units currently available',
    'beaverpatch.assigning': 'Assigning...',
    'beaverpatch.assign': 'Assign',
    'beaverpatch.close': 'Close',
    'beaverpatch.returnToService': 'Return to Service',
    'beaverpatch.minutesAvg': 'minutes avg',
    'beaverpatch.outOfTotal': 'out of',
    'beaverpatch.total': 'total',
    'beaverpatch.highPriority': 'high priority',
    'beaverpatch.recentActivity': 'Recent Activity',
    'beaverpatch.callInfo': 'Call Info',
    'beaverpatch.location': 'Location',
    'beaverpatch.dmv': 'DMV',
    'beaverpatch.triage': 'Triage',
    'beaverpatch.details': 'Details',
    'beaverpatch.incidentId': 'Incident ID',
    'beaverpatch.pending': 'Pending',
    'beaverpatch.callBackPhone': 'Call Back Phone',
    'beaverpatch.callerName': 'Caller Name',
    'beaverpatch.locationPhone': 'Location Phone',
    'beaverpatch.calledFrom': 'Called From',
  ...
  fr: {
    ...
    'beaverpatch.initialCallInformation': 'Informations d\'appel initial',
    'beaverpatch.dispatchMap': 'Carte de répartition',
    'beaverpatch.unitStatus': 'Statut des unités',
    'beaverpatch.assignUnits': 'Assigner des unités',
    'beaverpatch.selectIncident': 'Sélectionner un incident',
    'beaverpatch.clickToAssignUnits': 'Cliquez sur un incident pour assigner des unités',
    'beaverpatch.availableUnits': 'Unités disponibles',
    'beaverpatch.noUnitsAvailable': 'Aucune unité actuellement disponible',
    'beaverpatch.assigning': 'Attribution...',
    'beaverpatch.assign': 'Assigner',
    'beaverpatch.close': 'Fermer',
    'beaverpatch.returnToService': 'Retour en service',
    'beaverpatch.minutesAvg': 'minutes moyenne',
    'beaverpatch.outOfTotal': 'sur',
    'beaverpatch.total': 'total',
    'beaverpatch.highPriority': 'haute priorité',
    'beaverpatch.recentActivity': 'Activité récente',
    'beaverpatch.callInfo': 'Info appel',
    'beaverpatch.location': 'Localisation',
    'beaverpatch.dmv': 'SAAQ',
    'beaverpatch.triage': 'Triage',
    'beaverpatch.details': 'Détails',
    'beaverpatch.incidentId': 'ID incident',
    'beaverpatch.pending': 'En attente',
    'beaverpatch.callBackPhone': 'Téléphone rappel',
    'beaverpatch.callerName': 'Nom de l\'appelant',
    'beaverpatch.locationPhone': 'Téléphone sur place',
    'beaverpatch.calledFrom': 'Appelé depuis',
